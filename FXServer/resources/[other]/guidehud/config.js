var config = {
  'title': 'SAVAGE RP',
  'welcomeMessage': 'WELCOME TO SAVAGE RP',
  // Add images for the loading screen background.
  images: [
  'https://i.pinimg.com/originals/cd/7f/92/cd7f922b19cd8f433790c9381e43bdef.jpg', 'https://wallpaper.dog/large/17119401.jpg', 'https://www.pixel4k.com/wp-content/uploads/2021/03/vulcar-hachura-r-gta-5-4k_1615134027.jpg',
  ],
  // Turn on/off music
  enableMusic: true,
  // Music list. (Youtube video IDs). Last one should not have a comma at the end.
  music: [
    'TkAUgrtS44Y', 'TkAUgrtS44Y', 'TkAUgrtS44Y', 'TkAUgrtS44Y'
  ],
  ...
  'discord': {
    'show': true,
    'discordLink': 'https://discord.gg/xeypzXNAee ',
  },
