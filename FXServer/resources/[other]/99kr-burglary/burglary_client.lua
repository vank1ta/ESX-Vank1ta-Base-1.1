...
local chancePoliceNoti        = 10          -- the procent police get notified (only numbers like 30, 10, 40. You get it.)
...
local text = "~g~[E]~w~ Разбии вратата" -- lockpick the door
local textUnlock = "~g~[E]~w~ Влез" -- enter the house
local insideText = "~g~[E]~w~ Излез" -- exit the door
local searchText = "~g~[E]~w~ Претърси" -- search the spot
local emptyMessage = "Тук е празно" -- if you press E where it is empty
local emptyMessage3D = "~r~Празно" -- if the spot is empty
local closetText = "~g~[E]~w~ Претърси" -- text at closet

local lockpickQuestionText = "Сигурен ли си че искаш да разбиеш вратата?" -- confirmation menu title
local noLockpickText = "Нямаш шпрерц!" -- if you don't have a lockpick and you try to do the burglary
local yesText = "Да" -- in confirmation menu
local noText = "Не" -- -- in confirmation menu

local shirt = "Предмет" -- in menu and notification
local pants = "Предмет" -- -- in menu and notification
local hat = "Предмет" -- -- in menu and notification
local shoes = "Предмет" -- -- in menu and notification

local youFound = "Ти намери" -- when you steal something
local burglaryDetected = "Обир на къща около" -- text 1 cops gets sent
local sentPhoto = "Изпратена ви е снимка на обирджията." -- if you use qalle's camerasystem this will be in the message too
...
local burglaryPlaces = {
    ...
    ["MirrorPark 2"] = {
        pos = { x = 1223.12, y = -697.06, z = 60.8, h = 278.88 },  -- door coords
        locked = true,
        inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 },  -- Inside the house coords
        animPos = { x = 1223.12, y = -697.06, z = 60.8, h = 278.88 },   -- The animation position
    },


    ["MirrorPark  3"] = {
      pos = { x = 1221.39, y = -669.32, z = 63.69, h = 191.41 },  -- door coords
      locked = true,
      inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 },  -- Inside the house coords
      animPos = { x = 1221.39, y = -669.32, z = 63.69, h = 191.41 },   -- The animation position
  },
  
}

local burglaryInside = {
    ["Saffron"] = { x = 342.23, y = -1003.29, z = -99.0, item = 'bijuta', amount = math.random(2,4)},
    ["Speaker"]  = {x = 338.14, y = -997.69, z = -99.2, item = 'hand_watch', amount = math.random(1,2)},
    ["Laptop"] = { x = 350.91 , y = -999.26 , z = -99.2, item = 'iphone', amount = 1},
    ["Bag of Cocaine"] = { x = 349.19, y = -994.83, z = -99.2, item = 'lockpick', amount = math.random(1,2)},
    ["Book"]  = { x = 345.3, y = -995.76, z = -99.2, item = 'playstation4', amount = math.random(1,2)},
    ["Coupon"] = { x = 346.14, y = -1001.55, z = -99.2, item = 'samsungs8', amount = math.random(1,3)},
    ["Toothpaste"] = { x = 347.23, y = -994.09, z = -99.2, item = 'tv', amount = math.random(1,2)},
    ["Lottery Ticket"] = { x = 339.23, y = -1003.35, z = -99.2, item = 'gopro', amount = math.random(1,5)}
}

local closets = {
    ["Robban's Closet"] = { x = 351.24, y = -993.53, z = -99.2, items = {'bijuta', 'hand_watch', 'iphone', 'playstation4'}, shirtAmount = math.random(1,3), pantsAmount = math.random(1,3), hatAmount = math.random(1,2), shoesAmount = math.random(1,2)},
}
...
if useBlip then
  Citizen.CreateThread(function()
    ...
    AddTextComponentString('Обир на къща')
