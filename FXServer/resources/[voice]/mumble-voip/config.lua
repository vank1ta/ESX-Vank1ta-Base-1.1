...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "Шептене"}, -- Whisper speech distance in gta distance units
		{8.0, "Нормално"}, -- Normal speech distance in gta distance units
		{20.0, "Викане"}, -- Shout speech distance in gta distance units
	},
