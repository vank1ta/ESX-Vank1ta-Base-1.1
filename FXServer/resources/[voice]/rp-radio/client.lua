...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " за да прибереш.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ за да включиш радиото.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ or ~" .. radioConfig.Controls.Increase.Name .. "~ за да смениш канала~n~~" .. radioConfig.Controls.Input.Name .. "~ за да избереш станция~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ за да спреш ефектите~n~Радиостанция: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " за да прибереш.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ за да изключиш радиото.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ за да говориш.~n~Радиоканал: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Въведете радиоканал" },
}
Radio.Commands = {
	{
