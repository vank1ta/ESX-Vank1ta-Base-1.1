	...
	PerformHttpRequest(VersionAPIRequest, function(err, rText, headers)
		...
		if err == 200 then
			if(not _FirstCheckPerformed)then
				print("\n" .. _Prefix .. " Essentialmode version: " .. _VERSION)
				print(_Prefix .. " Essentialmode newest version: " .. decoded.newVersion .. "\n")
...
Citizen.CreateThread(function()
	...
	print("Този сървъра е направен, изцяло от SAVAGE™. Моля не разпространявай!")
end)
