...
Config.AuthorizedWeapons = {
	recruit = {
		{ weapon = 'WEAPON_PISTOL', components = { 0, 0, 1000, 4000, nil }, price = 500 },
...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'psp_ftipo2', label = 'Police Fiat Tipo', price = 1 },
		{ model = 'ghispo2', label = 'Police Fiat Tipo', price = 1 }
	},
	...
	sergeant = {
		{ model = 'polschafter3', label = 'Unmarked', price = 1 }
	},
